...
class AIServiceTest {
    ...
    class GetHint {
        ...
        void returnsAResponse() throws Exception {
            ...
            String response = aiService.getHint("What is 2 + 2?", "I don't know", history);
        ...
        void worksWithEmptyHistory() throws Exception {
            List<String[]> history = new ArrayList<>();
            assertDoesNotThrow(() ->
                    aiService.getHint("What is 2 + 2?", "I don't know", history)
            );
        }
        ...
        void worksWithConversationHistory() throws Exception {
            ...
            String response = aiService.getHint("What is 2 + 2?", "addition?", history);
            assertNotNull(response);
            assertFalse(response.isEmpty());
        }
    }
